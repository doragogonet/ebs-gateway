...
{
	TIMEOFDAY* startTime; /**< Specific time of day (9 charactors "12:45:78") to start trigger. It's second unit such as E8:32:14E[0~23]:[0~59]:[0:59]. if string is empty, equivalent to E0:00:00E timeofday is on the mid-night.*/
...
* Currently supports only “periodic trigger reportE
*/
...
* For example, “all tagsEis specified using a mask length of zero.
*/
